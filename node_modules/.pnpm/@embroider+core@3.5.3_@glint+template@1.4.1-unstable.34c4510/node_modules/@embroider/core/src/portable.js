...
exports.maybeNodeModuleVersion = maybeNodeModuleVersion;
...
const { findUpPackagePath } = resolve_package_path_1.default;
function maybeNodeModuleVersion(path) {
        ...
        switch (typeof value) {
            ...
            case 'object':
                if (Object.getPrototypeOf(value) === Object.prototype) {
                    ...
                    let result = (0, mapValues_1.default)(value, (propertyValue, key) => {
        ...
        if (input && typeof input === 'object') {
            if (input.embroiderPlaceholder) {
                ...
                switch (placeholder.type) {
                    ...
                    default:
                        (0, assert_never_1.default)(placeholder);
                }
            }
            else {
                return (0, mapValues_1.default)(input, (value, key) => this.hydrate(value, accessPath.concat(key)));
            }
        }
        return input;
    }
