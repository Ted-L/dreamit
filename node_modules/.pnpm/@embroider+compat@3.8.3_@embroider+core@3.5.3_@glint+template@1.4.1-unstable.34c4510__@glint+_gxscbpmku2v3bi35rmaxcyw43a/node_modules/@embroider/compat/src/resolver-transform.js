...
function supportsThisFallback(emberVersion) {
    return (0, semver_1.satisfies)(emberVersion, '<= 4.0.0-alpha.0', { includePrerelease: true });
}
class TemplateResolver {
    constructor(env, config, builtInsForEmberVersion, supportsThisFallback, externalNameHint) {
        this.env = env;
        this.config = config;
        this.builtInsForEmberVersion = builtInsForEmberVersion;
        this.supportsThisFallback = supportsThisFallback;
        this.externalNameHint = externalNameHint;
    ...
    nameHint(path) {
        ...
        // HTML element.
        return (_b = (_a = this.externalNameHint) === null || _a === void 0 ? void 0 : _a.call(this, path)) !== null && _b !== void 0 ? _b : parts[parts.length - 1] + '_';
    }
...
function makeResolverTransform({ appRoot, emberVersion, externalNameHint }) {
    ...
    const resolverTransform = env => {
        ...
        return new TemplateResolver(env, config, builtInKeywords(emberVersion), supportsThisFallback(emberVersion), externalNameHint);
    };
