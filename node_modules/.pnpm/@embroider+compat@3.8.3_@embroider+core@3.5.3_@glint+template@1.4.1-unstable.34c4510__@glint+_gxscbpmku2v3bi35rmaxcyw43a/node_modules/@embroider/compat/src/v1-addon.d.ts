...
export default class V1Addon {
    ...
    private orderIdx;
    constructor(addonInstance: AddonInstance, addonOptions: CompatOptionsType, app: CompatApp, packageCache: PackageCache, orderIdx: number);
...
export interface V1AddonConstructor {
    new (addonInstance: any, options: CompatOptionsType, app: CompatApp, packageCache: PackageCache, orderIdx: number): V1Addon;
