...
export function createEmberLanguagePlugin(glintConfig) {
    return {
        ...
        createVirtualCode(scriptId, languageId, snapshot, codegenContext) {
            ...
            if (glintConfig.enableTsPlugin && // Loose mode not supported for classic "takeover" mode, only TS Plugin
                ...
                return new LooseModeBackingComponentClassVirtualCode(glintConfig, snapshot, scriptId, codegenContext);
            }
